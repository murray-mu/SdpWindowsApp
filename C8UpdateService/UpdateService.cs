...
using C8UpdateService.Utils;
using C8UpdateService.Checkers;
...
namespace C8UpdateService {
    public partial class UpdateService : ServiceBase {
        ...
        protected override void OnStart(string[] args) {
            ...
            AccessUtils.GrantAccessToFile(Path.Combine(exeLocation, "C8UpdateService.exe.config")); //allow anyone to change the config file
            AccessUtils.GrantAccessToFile(Path.Combine(exeLocation, "C8UpdateService-log.config")); //allow anyone to change the log file config
            AccessUtils.GrantAccessToFile(Path.Combine(exeLocation, "C8Edge.exe.config")); //allow anyone to change the config file
            AccessUtils.GrantAccessToFile(Path.Combine(exeLocation, "C8Edge-log.config")); //allow anyone to change the log file config
...
#pragma warning restore 1998 //This async method lacks 'await'
        ...
        async private Task StopUI() {
            ...
            stopProcessForcefully("C8Edge", "UI");
        }
