...
namespace C8UpdateService.Utils {
    internal class Settings {
        ...
        private void init() {
            string folder = Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.ApplicationData), "NetFoundry", "C8UpdateService");
