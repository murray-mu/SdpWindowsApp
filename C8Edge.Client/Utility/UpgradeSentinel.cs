...
namespace C8Edge.Utility {
    public class UpgradeSentinel {
        private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        public const string C8UpgradeSentinelExeName = "C8UpgradeSentinel.exe";
        private static string SentinelTempSource = Path.Combine(Path.GetTempPath(), C8UpgradeSentinelExeName);
        ...
        public static void StartUpgradeSentinel() {
            ...
            using (Process process = new Process()) {
                ...
                var sentinelSource = Path.Combine(executableDirectory, C8UpgradeSentinelExeName);
